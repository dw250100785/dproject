...
class dproject_task_reevaluate(osv.osv_memory):
    _name = 'dproject.task.reevaluate'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        res = super(dproject_task_reevaluate, self).fields_view_get(cr, uid, view_id, view_type, context, toolbar, submenu=submenu)
